...
var WildMagicSurgeTable = WildMagicSurgeTable || (function() {
    ...
    var version = 0.1,
        ...
        table = [
            ...
            {range: [11,12], result: "Roll a d10. Your height changes a number of inches on the roll.  You shrink if the number is Odd, grow if the number is even."},
            ...
            {range: [35,36], result: "Roll a d10. Your age changes a number of years on the roll.  You age if the number is Odd, become younger if the number is even."},
